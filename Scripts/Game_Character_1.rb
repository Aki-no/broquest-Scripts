...
class Game_Character
  ...
  attr_accessor :last_move                # record player's last move for Game_Follower (0 none 1 down 2 up 3 left 4 right)
  #--------------------------------------------------------------------------
  ...
  #     x : x-coordinate
  #     y : y-coordinate
  #     d : direction (0,2-down,4-left,6-right,8-up)
